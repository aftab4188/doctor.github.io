<footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Rahim Yar khan<br>
              Campus <br><br>
              <strong>Phone:</strong> 03097661879<br>
              <strong>Email:</strong> iubryk@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Account Details For online payment</h4>
            <p>Easypaisa : 03459578470</p>
            <p>JazzCash : 03459578470</p> 
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>IUB Doc</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
   
          Designed by <a href="">Aftab and  Abrar</a>
        </div>
      </div>
